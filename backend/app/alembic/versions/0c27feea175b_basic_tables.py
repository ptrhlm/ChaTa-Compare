...
def upgrade():
    ...
    op.create_index(op.f('ix_chart_description'),
                    'chart', ['description'],
                    unique=False)
    ...
    op.create_index(op.f('ix_chart_x_axis_title'),
                    'chart', ['x_axis_title'],
                    unique=False)
    op.create_index(op.f('ix_chart_y_axis_title'),
                    'chart', ['y_axis_title'],
                    unique=False)
    op.create_table(
        'survey', sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('name', sa.String(length=200), nullable=True),
        sa.Column('description', sa.String(length=4000), nullable=True),
        sa.Column('status',
                  sa.Enum('OPEN', 'CLOSED', name='surveystatus'),
                  nullable=True),
        sa.Column('type',
                  sa.Enum('SINGLE', 'COMPARISON', name='surveytype'),
                  nullable=True),
    ...
    op.create_index(op.f('ix_survey_researcher_id'),
                    'survey', ['researcher_id'],
                    unique=False)
    op.create_index(op.f('ix_survey_status'),
                    'survey', ['status'],
                    unique=False)
    ...
    op.create_table('criterion', sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('name', sa.String(length=200), nullable=True),
                    sa.Column('survey_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(
                        ['survey_id'],
    ...
    op.create_index(op.f('ix_criterion_name'),
                    'criterion', ['name'],
                    unique=False)
    op.create_index(op.f('ix_criterion_survey_id'),
                    'criterion', ['survey_id'],
                    unique=False)
    ...
    op.create_index(op.f('ix_task_chart1_id'),
                    'task', ['chart1_id'],
                    unique=False)
    op.create_index(op.f('ix_task_chart2_id'),
                    'task', ['chart2_id'],
                    unique=False)
    op.create_index(op.f('ix_task_id'), 'task', ['id'], unique=False)
    op.create_index(op.f('ix_task_survey_id'),
                    'task', ['survey_id'],
                    unique=False)
    op.create_table(
        'answer', sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_answer_criterion_id'),
                    'answer', ['criterion_id'],
                    unique=False)
    op.create_index(op.f('ix_answer_id'), 'answer', ['id'], unique=False)
    op.create_index(op.f('ix_answer_task_id'),
                    'answer', ['task_id'],
                    unique=False)
    op.create_index(op.f('ix_answer_user_id'),
                    'answer', ['user_id'],
                    unique=False)
    ...
    op.create_index(op.f('ix_report_task_id'),
                    'report', ['task_id'],
                    unique=False)
    op.create_index(op.f('ix_report_user_id'),
                    'report', ['user_id'],
                    unique=False)
