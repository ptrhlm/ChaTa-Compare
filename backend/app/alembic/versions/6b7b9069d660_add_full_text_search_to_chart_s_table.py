"""Add full-text search to chart's table

Revision ID: 6b7b9069d660
Revises: 0c27feea175b
Create Date: 2019-05-19 20:19:11.542379
...
revision = '6b7b9069d660'
down_revision = '0c27feea175b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    conn = op.get_bind()
    op.add_column('chart', sa.Column('search_vector', sqlalchemy_utils.types.ts_vector.TSVectorType()))

    sync_trigger(conn, 'chart', 'search_vector', ['title', 'x_axis_title', 'y_axis_title', 'description'])
    conn.execute(
        text(
            """
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('chart', 'search_vector')
    # ### end Alembic commands ###
