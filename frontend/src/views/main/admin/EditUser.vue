      ...
      <v-card-text>
        <template>
          ...
          <v-form v-model="valid"
              ...
              <v-checkbox label="Is Superuser"
                          v-model="isSuperuser"></v-checkbox>
              ...
              <div class="subheading secondary--text text--lighten-2">User is researcher <span v-if="isResearcher">(currently is a researcher)</span><span v-else>(currently is not a researcher)</span></div>
              <v-checkbox label="Is Researcher"
                          v-model="isResearcher"></v-checkbox>
              <v-layout align-center>
                  ...
                  <v-flex>
                      <v-text-field :disabled="!setPassword"
                                    type="password"
                                    ref="password"
                                    label="Set Password"
                      ...
                      <v-text-field v-show="setPassword"
                                    type="password"
...
export default class EditUser extends Vue {
  ...
  public reset() {
    ...
    if (this.user) {
      ...
      this.isResearcher = this.user.is_researcher;
  ...
  public async submit() {
    if (await this.$validator.validateAll()) {
      ...
      updatedProfile.is_researcher = this.isResearcher;
